package com.topraktunca.element.world.gen;
...
public class ModOreGen {
    ...
    public static void generateOres(FMLLoadCompleteEvent event) {
        for (Biome biome : ForgeRegistries.BIOMES) {
            genOre(biome, 4, 8, 5, 17,OreFeatureConfig.FillerBlockType.NATURAL_STONE,
                    RegistryHandler.T_ORE.get().getDefaultState(), 3);
        }
    }
